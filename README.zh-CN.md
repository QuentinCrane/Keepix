...
- 支持简体中文、台湾繁体中文和英文，使用 Android 标准资源体系适配系统语言和应用语言设置。
- 应用名随语言变化：简体中文为 `看了么`，繁体中文为 `看了麼`，英文为 `Keepix`。
- 繁体中文按台湾常用表达适配，例如 `相簿`、`資料夾`、`影片`、`垃圾桶`。
- 英文文案按产品语境重写，核心术语使用 `Clean`、`Keep`、`Favorite`、`Pending delete`、`Trash`、`Album`、`Folder`。
- App 不额外提供应用内语言开关，跟随系统语言和 Android 应用语言设置。
