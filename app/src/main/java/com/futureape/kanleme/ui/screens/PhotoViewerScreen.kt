    ...
    Box(
        ...
        Row(
            ...
            Column(Modifier.weight(1f)) {
                ...
                Text(
                    text = "${pagerState.currentPage + 1} / ${photos.size} · ${currentPhoto?.folderName.orEmpty()}",
        ...
        currentPhoto?.let { photo ->
            GlassSurface(
                ...
                Row(
                    ...
                    ViewerAction(icon = Icons.Rounded.PhotoLibrary, label = "相册查看") {
...
private fun MoveFolderSheet(
    ...
    var customPath by remember(currentPhoto.id) { mutableStateOf(currentPhoto.relativePath ?: "Pictures/看了么精选/") }
    ...
    ModalBottomSheet(onDismissRequest = onDismiss) {
        Column(
            ...
            Text(
                "目标路径使用相册相对路径，例如 Pictures/看了么精选/。系统可能会要求照片写入授权。",
